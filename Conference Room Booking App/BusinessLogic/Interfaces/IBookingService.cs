...
namespace Conference_Room_Booking_App.BusinessLogic.Interfaces
{
    public interface IBookingService
    {
        ...
        Task<Booking?> CreateBookingAsync(int roomId, BookingInfoViewModel bookingInfo, ReservationHolderViewModel reservationHolder);
        Task<Booking?> UpdateBookingAsync(int bookingId, BookingInfoViewModel bookingInfo, ReservationHolderViewModel reservationHolder);
