...
builder.Services.AddDefaultIdentity<AppUser>(options => options.SignIn.RequireConfirmedAccount = false) //FEATURE: Switch to true if you want to allow only verified accounts to login
