...
namespace Conference_Room_Booking_App.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // Check if ID Card Number is already taken
                var existingUser = await _userManager.Users
                    .FirstOrDefaultAsync(u => u.IdCardNumber == Input.IdCardNumber);

                if (existingUser != null)
                {
                    ModelState.AddModelError("Input.IdCardNumber", "This ID Card Number is already registered.");
                    return Page();
                }
